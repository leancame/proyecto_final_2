            ...
            while True:
                try:
                    ...
                    if entrada:
                        ...
                        self.voz.hablar("No entendí, intenta de nuevo o di 'adiós' para salir.")
                except Exception as e:
                    print(f"[ERROR Conversación IA]: {e}")
                    self.voz.hablar("Hubo un error durante la conversación con la IA.")
        except Exception as e:
            print(f"[ERROR ComandoIA]: {e}")
            self.voz.hablar("Ocurrió un error al ejecutar el comando de inteligencia artificial.")
